...
use App\Http\Controllers\Backend\ReportController as AdminReportController;
...
Route::middleware('auth:web')->group(function () {
    ...
    Route::get('account/orders/{order}', [OrderTrackingController::class, 'show'])->name('dashboard.orders.show');
    Route::get('account/orders/{order}/invoice', [OrderTrackingController::class, 'invoice'])->name('dashboard.orders.invoice');
