...
<html lang="en">
<head>
  <title>{{ $globalSiteInfo?->site_name ?? 'Bigdeal Marketplace' }}</title>
  ...
  <style>.frontend-site-logo{max-width:170px;max-height:64px;object-fit:contain}</style>
</head>
<body class="bg-light ">
                ...
                <nav id="main-nav">
                  ...
                  <ul id="main-menu" class="sm pixelstrap sm-horizontal">
                    ...
                    <li>
                      ...
                      <ul>
                        <li><a target="_blank" href="{{ route('home') }}">layout 1</a></li>
                                ...
                                <div class="link-section">
                                  ...
                                  <div class="menu-content">
                                    <ul>
                                      ...
                                      <li><a href="{{ route('home') }}">cart top</a></li>
      ...
      <div class="col pr-0">
        <div class="theme-tab product mb--5">
          <div class="tab-content-cls">
                    ...
                    <div class="product-box">
                      ...
                      <div class="product-detail detail-inline">
                        <div class="detail-title">
                          ...
                          <div class="detail-right"><div class="check-price">@if($product->offer_price) $ {{ number_format($product->price, 2) }} @endif</div><div class="price"><div class="price">$ {{ number_format($displayPrice, 2) }}</div></div></div>
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <div id="tab-2" class="tab-content"><div class="product-slide-6 product-m no-arrow">@foreach($globalFrontendProducts->where('is_featured', true) as $product)<div><div class="product-box"><div class="product-imgbox"><a href="{{ route('products.show', $product) }}"><img src="{{ $product->thumbnail_path ? asset('storage/'.$product->thumbnail_path) : asset('assets/images/layout-2/product/3.jpg') }}" class="img-fluid" alt="{{ $product->name }}"></a>@if ($product->stock_quantity <= 0)<div class="on-sale1">stock out</div>@endif</div><div class="product-detail detail-inline"><a href="{{ route('products.show', $product) }}"><h6 class="price-title">{{ $product->name }}</h6></a><div class="price">$ {{ number_format($product->offer_price ?: $product->price, 2) }}</div></div></div></div>@endforeach</div></div>
            <div id="tab-3" class="tab-content"><div class="product-slide-6 product-m no-arrow">@foreach($globalFrontendProducts->take(6) as $product)<div><div class="product-box"><div class="product-imgbox"><a href="{{ route('products.show', $product) }}"><img src="{{ $product->thumbnail_path ? asset('storage/'.$product->thumbnail_path) : asset('assets/images/layout-2/product/4.jpg') }}" class="img-fluid" alt="{{ $product->name }}"></a>@if ($product->stock_quantity <= 0)<div class="on-sale1">stock out</div>@endif</div><div class="product-detail detail-inline"><a href="{{ route('products.show', $product) }}"><h6 class="price-title">{{ $product->name }}</h6></a><div class="price">$ {{ number_format($product->offer_price ?: $product->price, 2) }}</div></div></div></div>@endforeach</div></div>
            <div id="tab-4" class="tab-content"><div class="product-slide-6 product-m no-arrow">@foreach($globalFrontendProducts->where('is_on_sale', true) as $product)<div><div class="product-box"><div class="product-imgbox"><a href="{{ route('products.show', $product) }}"><img src="{{ $product->thumbnail_path ? asset('storage/'.$product->thumbnail_path) : asset('assets/images/layout-2/product/5.jpg') }}" class="img-fluid" alt="{{ $product->name }}"></a>@if ($product->stock_quantity <= 0)<div class="on-sale1">stock out</div>@endif</div><div class="product-detail detail-inline"><a href="{{ route('products.show', $product) }}"><h6 class="price-title">{{ $product->name }}</h6></a><div class="price">$ {{ number_format($product->offer_price ?: $product->price, 2) }}</div></div></div></div>@endforeach</div></div>
          </div>
        </div>
      </div>
    </div>
