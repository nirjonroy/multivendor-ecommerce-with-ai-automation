                ...
                <ul class="nav-menus">
                    ...
                    <li class="onhover-dropdown">
                        ...
                        <ul class="profile-dropdown onhover-show-div p-20 profile-dropdown-hover">
                            ...
                            <li><a href="#">Settings<span class="pull-right"><i data-feather="settings"></i></span></a></li><li><form method="POST" action="{{ route('admin.logout') }}">@csrf<button type="submit" class="btn btn-link p-0 text-left w-100">Logout<span class="pull-right"><i data-feather="log-out"></i></span></button></form></li>
                        </ul>
                    </li>
                </ul>
...
@if(($pendingVendorProducts ?? collect())->isNotEmpty())
                ...
                <div class="modal-body">
                    <div class="table-responsive">
                        <table class="table table-bordernone">
                            ...
                            <tbody>
                                @foreach($pendingVendorProducts as $pendingProduct)
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            ...
                                            <button class="btn btn-sm btn-danger" type="button" data-toggle="collapse" data-target="#reject-product-{{ $pendingProduct->id }}">Reject</button>
                                            <form id="reject-product-{{ $pendingProduct->id }}" class="collapse mt-2" method="POST" action="{{ route('admin.products.reject', $pendingProduct) }}">
                                                @csrf
                                                @method('PATCH')
